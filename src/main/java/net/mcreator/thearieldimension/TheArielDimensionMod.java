 ...
 *
 */
package net.mcreator.thearieldimension;
...
@Mod("the_ariel_dimension")
public class TheArielDimensionMod {
	public static final Logger LOGGER = LogManager.getLogger(TheArielDimensionMod.class);
	public static final String MODID = "the_ariel_dimension";

	public TheArielDimensionMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		TheArielDimensionModBlocks.REGISTRY.register(bus);
		TheArielDimensionModItems.REGISTRY.register(bus);
		TheArielDimensionModEntities.REGISTRY.register(bus);
