...
package net.mcreator.thearieldimension.fluid.types;
...
public class AcidFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("the_ariel_dimension:block/acid_still"), FLOWING_TEXTURE = new ResourceLocation("the_ariel_dimension:block/acid_flow");
