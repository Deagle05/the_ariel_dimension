...
public class FireBulletRenderer extends EntityRenderer<FireBulletEntity> {
	private static final ResourceLocation texture = new ResourceLocation("the_ariel_dimension:textures/entities/firebullet.png");
	private final Modelfirebullet model;

	public FireBulletRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelfirebullet(context.bakeLayer(Modelfirebullet.LAYER_LOCATION));
	}

	@Override
	public void render(FireBulletEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
