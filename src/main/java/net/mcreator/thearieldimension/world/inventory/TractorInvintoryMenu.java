...
package net.mcreator.thearieldimension.world.inventory;
...
public class TractorInvintoryMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TractorInvintoryMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheArielDimensionModMenus.TRACTOR_INVINTORY.get(), id);
		...
		this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 25, 40) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
		}));
		this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 43, 40) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
		...
		this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 79, 40) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
		}));
		this.customSlots.put(13, this.addSlot(new SlotItemHandler(internal, 13, 97, 40) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
		}));
		this.customSlots.put(14, this.addSlot(new SlotItemHandler(internal, 14, 115, 40) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
		}));
		this.customSlots.put(15, this.addSlot(new SlotItemHandler(internal, 15, 133, 40) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return false;
			}
