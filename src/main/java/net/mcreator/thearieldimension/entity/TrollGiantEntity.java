...
public class TrollGiantEntity extends Monster {
	public TrollGiantEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheArielDimensionModEntities.TROLL_GIANT.get(), world);
	}

	public TrollGiantEntity(EntityType<TrollGiantEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
