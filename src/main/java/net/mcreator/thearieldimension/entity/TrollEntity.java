...
public class TrollEntity extends Monster {
	public TrollEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheArielDimensionModEntities.TROLL.get(), world);
	}
	...
	public TrollEntity(EntityType<TrollEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(Blocks.RED_BANNER));
	}
	...
	public static void init() {
		SpawnPlacements.register(TheArielDimensionModEntities.TROLL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
