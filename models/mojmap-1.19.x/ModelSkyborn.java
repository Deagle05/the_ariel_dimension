...
public class ModelSkyborn<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "skyborn"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create()
				.texOffs(24, 26).addBox(0.0F, 0.0F, -2.0F, 4.0F, 15.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 9.0F, 0.0F));

		PartDefinition right_leg2 = partdefinition.addOrReplaceChild("right_leg2", CubeListBuilder.create()
				.texOffs(24, 26).addBox(-4.0F, 0.0F, -2.0F, 4.0F, 15.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 9.0F, 0.0F));

		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(-4.0F, -30.0F, -2.0F, 8.0F, 15.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 5)
						.addBox(4.0F, -30.0F, -2.0F, 9.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 5)
						.addBox(-13.0F, -30.0F, -2.0F, 9.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, -9.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.0F, 0.0F));

		PartDefinition wings = partdefinition.addOrReplaceChild("wings",
				CubeListBuilder.create().texOffs(24, 16)
						.addBox(1.0F, -30.0F, 2.0F, 12.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 45)
						.addBox(1.0F, -30.0F, 2.0F, 12.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 53)
						.addBox(-13.0F, -30.0F, 2.0F, 12.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 45)
						.addBox(-13.0F, -30.0F, 2.0F, 12.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition r2_arm = partdefinition.addOrReplaceChild("r2_arm", CubeListBuilder.create().texOffs(0, 35)
				.addBox(9.0F, -1.0F, -2.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -4.0F, 0.0F));

		PartDefinition r1_arm = partdefinition.addOrReplaceChild("r1_arm", CubeListBuilder.create().texOffs(0, 35)
				.addBox(4.0F, -1.0F, -2.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -4.0F, 0.0F));

		PartDefinition l1_arm = partdefinition.addOrReplaceChild("l1_arm", CubeListBuilder.create().texOffs(0, 35)
				.addBox(-8.0F, -1.0F, -2.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -4.0F, 0.0F));

		PartDefinition l1_arm2 = partdefinition.addOrReplaceChild("l1_arm2", CubeListBuilder.create().texOffs(0, 35)
				.addBox(-8.0F, -1.0F, -2.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0F)),
